...
#import "XibAutoHeightViewController.h"
#import "XibListTableViewCell.h"

static NSString * const kXibCellId = @"xibCellId";

@interface XibAutoHeightViewController () <
                                            UITableViewDelegate,
...
@implementation XibAutoHeightViewController
...
- (void)configTableView
{
    ...
    [self.xibTableView registerNib:[UINib nibWithNibName:NSStringFromClass([XibListTableViewCell class])
                                                  bundle:nil]
            forCellReuseIdentifier:kXibCellId];
    self.xibTableView.separatorStyle  = UITableViewCellSeparatorStyleNone;
    self.xibTableView.backgroundColor = BG_COLOR;
}
...
{
    XibListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kXibCellId
